...
export default function App() {
  ...
  return (
    <div style={{
      ...
      {/* ── Avatar panel ─────────────────────────────────── */}
      <div style={{
        width: isMobile ? "100%" : "clamp(260px, 32vw, 480px)",
        ...
        gap: isMobile ? 12 : 20,
        padding: isMobile ? "10px 16px" : 32,
        boxSizing: "border-box",
      }}>
        <div style={{
          width: isMobile ? 70 : "clamp(180px, 22vw, 360px)",
          height: isMobile ? 70 : "clamp(180px, 22vw, 360px)",
          flexShrink: 0,
          borderRadius: "50%",
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: isMobile ? 2 : 8 }}>
          <div style={{ color: "white", fontSize: isMobile ? 13 : 18, fontWeight: 700, letterSpacing: 3 }}>
            NADRA AI
          </div>
          {!isMobile && (
            <div style={{ color: COLORS.gold, fontSize: 11, letterSpacing: 2 }}>
              NATIONAL IDENTITY AUTHORITY
            </div>
          )}
          <div
            onClick={() => { closeSimli(); stopSilence(); setVideoVisible(false); initSimli(); }}
            style={{ color: statusColor, fontSize: isMobile ? 9 : 10, letterSpacing: 1.5, textTransform: "uppercase", cursor: "pointer" }}
          >
            {simliStatus.text}
          </div>
        </div>
      ...
      {/* ── Chat panel ───────────────────────────────────── */}
      <div style={{ flex: 1, display: "flex", flexDirection: "column", overflow: "hidden", minHeight: 0, height: isMobile ? "calc(100vh - 90px)" : "100%" }}>
        ...
        {/* {!isMobile && (
          <div style={{
            ...
            <h1 style={{ fontSize: 18, fontWeight: 600, color: COLORS.text }}>NADRA Assistant</h1>
